...
<body>
		...
		<div class="main-nav-container">
						...
						<ul class="navbar-nav ml-auto">
							<li class="nav-item dropdown">
								...
								<div class="dropdown-menu bg-purple">
									<a class="nav-link text-dark decor " href="#">
									...
									<a class="nav-link text-dark decor" href="signup.php">
			...
			<div class="header-with-search">
				...
				<div class="account-nav border-center">
					<a href="shopcart.php" style="text-decoration: none; color: inherit; font-size: 150%;">
		...
		<div class="Quick-search">
			...
			<div class="Price-select select">
				<select name="prices">
					...
					<option value="Anniversary Flower">300000-400000</option>
					<option value="Decoration Flower">>40000000</option>
				</select>
			</div>
	...
	<div id="content" class="smtop">
		<div class="img-about">
			<!-- <img src="./assets/images/Content/contentbg/content1.png" alt="" class="img-intro"> -->
	...
	<div id="product" class="smtop">
		...
		<div class="container-fluid">
			<div class="row members-list">
				<div class="col-6 col-sm-4 .col-md-1 col-lg-4 mb-5">
					<div class="card ">
						<div class="card-body item-product center">
							<div class="row">
								<div class="col-lg-6">
									<img src="./assets/images/Content/Product/product1.webp" alt=""
										class="card-img-top pic-product">
								</div>
								<div class="col-lg-6 text">
									<h4 class="card-title text-center">Chậu Hoa</h4>
									<p class="text-muted" style="font-size:13px;">Hoa hồng - biểu tượng của tình yêu và
										sự đam mê, mang trong mình một vẻ đẹp tinh tế và quyến rũ.</p>
									<p class="card-text text-center">20000 VND</p>
									<button class="btn-normal s-full-width js-buy-btn">Add to cart</button>
								</div>
							</div>
						</div>
					</div>
							...
							<div class="card-body item-product center">
								<div class="row">
									...
									<div class="col-lg-6 text-center">
										<h4 class="card-title text-center">Chậu Hoa</h4>
										<p class="text-muted" style="font-size:13px;">Hoa hồng - biểu tượng của tình yêu
											và sự đam mê, mang trong mình một vẻ đẹp tinh tế và quyến rũ.</p>
										<p class="card-text text-center">20000 VND</p>
										<button class="btn-normal s-full-width js-buy-btn">Add to cart</button>
									</div>
								</div>
